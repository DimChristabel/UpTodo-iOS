...
// MARK: - Profile Section Label
// Grey section header text
// Used in: ProfileView
...
// MARK: - Profile Row Item
// Row with icon, title and chevron
// Used in: ProfileView
...
// MARK: - Profile Logout Button
// Red logout button at bottom of profile
// Used in: ProfileView
struct ProfileLogoutButton: View {
    let action    : () -> Void
    var iconName  : String      = "rectangle.portrait.and.arrow.right"
    var iconSize  : CGFloat     = 18
...
// Row with icon title and chevron for settings
...
#Preview {
    ZStack {
        ...
        VStack(spacing: 0) {
            HStack(spacing: 12) {
                ProfileBadge(title: "10 Task left")
                ProfileBadge(title: "5 Task done")
            }
