...
/// Displays the onboarding page indicator.
///
/// Highlights the currently active onboarding
/// slide while showing the remaining slides
/// as inactive indicators.
...
/// Displays the primary heading shown
/// on an onboarding slide.
...
// MARK: - OnboardingSubtitle

/// Displays supporting descriptive text
/// beneath the onboarding title.
///
/// Provides additional context about the
/// feature or benefit being introduced.
